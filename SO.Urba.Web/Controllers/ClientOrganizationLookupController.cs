...
{
      [Authorize]
    public class ClientOrganizationLookupController : Controller
    {
        ...
        {
            var results = clientOrganizationLookupManager.getAll(null);
        ...
        {
            var result = clientOrganizationLookupManager.get(id);
            return View(result); 
        }
        ...
        {
            clientOrganizationLookupManager.delete(id);
            return RedirectToAction("Index");
        }
